...
define lconstant gen_closure(lab_list, props, nargs, flags, b_pdpt, u_pdpt,
	...
	define lconstant gen_clos(lab_list, nargs, upd, pdpt, frozl);
		...
		asm_outword(getlabstr(hd(lab_list)),	;;; PD_EXECUTE
					...
					2);
#_IF DEF ALPHA_OSF1
		;;; crummy assembler doesn't like .long _____label where _____label is forward
		;;; defined
...
#_ENDIF
	...
	;;; 'poplink_4' which comes _____after the pop object modules in the link
...
#_ENDIF
	...
	;;; set xlink type first if it appears in __________link_other
...
--- John Gibson, Mar 17 1995
		...
		______before the pop object modules, otherwise symbols it references
...
--- Robert John Duncan, Jun 11 1993
		...
		by gen_link_command which takes ____________popexternlib as an additional argument
