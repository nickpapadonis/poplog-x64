...
takeout $poplocal/local/lib/river.p
...
terminator $poplocal/local/lib/buildindex.p
terminpdr $usepop/pop/lisp/src/tmacs.p
test $poplocal/local/lib/gramdemo.p
...
test_boxes $poplocal/local/lib/connect4.p
...
test_fitness_function $poplocal/local/lib/ga.p
...
testeq $poplocal/local/lib/logic.p
...
testmember $poplocal/local/lib/gramdemo.p
...
toggle $poplocal/local/lib/connect4.p
...
tournament_select $poplocal/local/lib/ga.p
tournament_selection $poplocal/local/lib/ga.p
...
transportable $poplocal/local/lib/river.p
...
tree_goals $poplocal/local/lib/newsolver.p
tree_plan $poplocal/local/lib/newsolver.p
...
tree_type $poplocal/local/lib/newsolver.p
...
truthtable $poplocal/local/lib/logic.p
truthtable $usepop/pop/packages/teaching/lib/logic.p
try $poplocal/local/lib/logic.p
...
tryall $usepop/pop/packages/rclib/auto/forevery.p
...
trystep $poplocal/local/lib/rhino.p
...
unique $poplocal/local/lib/msblocks.p
...
update_calc_and_redraw $poplocal/local/lib/connect4.p
...
update_history $poplocal/local/lib/connect4.p
...
update_max_depth_level $poplocal/local/lib/connect4.p
update_method $usepop/pop/lib/objectclass/src/methods.p
update_mkimagetool_window $usepop/pop/x/ui/lib/pop_ui_projecttool.p
update_mode $poplocal/local/lib/connect4.p
update_moves $poplocal/local/lib/connect4.p
...
update_skill $poplocal/local/lib/connect4.p
