...
define lconstant Try_array_equal(x, y, k1, k2);
	...
	if k1 == bitvector_key then
		/* Can use fast_subscrs for comparing bit-vectors
			if ___lo1 and ___lo2 are byte-aligned.
		*/
		lblock;
...
--- John Williams, Jun 23 1994
		_______________Try_array_equal no longer assumes last byte of a vector padded
		with 0's (for safety).
...
--- John Williams, Aug 31 1993
		_______Temp_b1 and _______Temp_b2 now writeable.
 */
