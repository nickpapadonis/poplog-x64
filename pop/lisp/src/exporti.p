...
define lconstant Exporti(sym, pdr, flag);
	...
	if updater(pdr) then
		if (isfunction_token(ft_setf_method(ftok)) ->> sym) then
			...
			/* The updater of ___pdr (inline code planter for ___sym)
...
/* This is here because it needs to be executed _____after char_code is
	exported to Lisp in _______exports
*/
